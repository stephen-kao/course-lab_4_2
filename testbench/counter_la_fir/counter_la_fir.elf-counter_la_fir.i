...
# 63 "counter_la_fir.c"
 ...
 (*(volatile uint32_t*)0x38001010) = DATA_LENGTH;


 int* tmp = fir();
 (*(volatile uint32_t*)0x38001020) = *(tmp );
 (*(volatile uint32_t*)0x38001024) = *(tmp+1 );
 (*(volatile uint32_t*)0x38001028) = *(tmp+2 );
 (*(volatile uint32_t*)0x3800102c) = *(tmp+3 );
 (*(volatile uint32_t*)0x38001030) = *(tmp+4 );
 (*(volatile uint32_t*)0x38001034) = *(tmp+5 );
 (*(volatile uint32_t*)0x38001038) = *(tmp+6 );
 (*(volatile uint32_t*)0x3800103c) = *(tmp+7 );
 (*(volatile uint32_t*)0x38001040) = *(tmp+8 );
 (*(volatile uint32_t*)0x38001044) = *(tmp+9 );
 (*(volatile uint32_t*)0x38001048) = *(tmp+10);

 (*(volatile uint32_t*)0x38004020) = *(tmp );
 (*(volatile uint32_t*)0x38004024) = *(tmp+1 );
 (*(volatile uint32_t*)0x38004028) = *(tmp+2 );
 (*(volatile uint32_t*)0x3800402c) = *(tmp+3 );
 (*(volatile uint32_t*)0x38004030) = *(tmp+4 );
 (*(volatile uint32_t*)0x38004034) = *(tmp+5 );
 (*(volatile uint32_t*)0x38004038) = *(tmp+6 );
 (*(volatile uint32_t*)0x3800403c) = *(tmp+7 );
 (*(volatile uint32_t*)0x38004040) = *(tmp+8 );
 (*(volatile uint32_t*)0x38004044) = *(tmp+9 );
 (*(volatile uint32_t*)0x38004048) = *(tmp+10);

 for(int j = 0; j < 3; j++){

  (*(volatile uint32_t*)0x2600000c) = 0x00A50000;
  (*(volatile uint32_t*)0x38001000) = 1;



  for (int i=0; i<DATA_LENGTH - 1; i++){
   (*(volatile uint32_t*)0x38002000) = *(tmp+i+N);





    (*(volatile uint32_t*)0x2600000c) = ((*(volatile uint32_t*) ((0xf0000000L + 0x3020L) + 8)) << 16);

  }
  (*(volatile uint32_t*)0x38002008) = *(tmp+DATA_LENGTH-1+N);
  (*(volatile uint32_t*)0x2600000c) = ((*(volatile uint32_t*) ((0xf0000000L + 0x3020L) + 8)) << 16);
  ...
  (*(volatile uint32_t*)0x2600000c) = ((*(volatile uint32_t*) ((0xf0000000L + 0x3020L) + 8)) << 24) + 0x005A0000;
 }
# 207 "counter_la_fir.c"
 (*(volatile uint32_t*)0x2600000c) = ((*(volatile uint32_t*) ((0xf0000000L + 0x3020L) + 8)) << 24) + 0x005A0000;
