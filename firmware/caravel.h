...
// user project (0x38000000)
#define reg_mprj_ap_signal   (*(volatile uint32_t*)0x38001000)
#define reg_mprj_data_length (*(volatile uint32_t*)0x38001010)

#define reg_mprj_coef0       (*(volatile uint32_t*)0x38001020)
#define reg_mprj_coef1       (*(volatile uint32_t*)0x38001024)
#define reg_mprj_coef2       (*(volatile uint32_t*)0x38001028)
#define reg_mprj_coef3       (*(volatile uint32_t*)0x3800102c)
#define reg_mprj_coef4       (*(volatile uint32_t*)0x38001030)
#define reg_mprj_coef5       (*(volatile uint32_t*)0x38001034)
#define reg_mprj_coef6       (*(volatile uint32_t*)0x38001038)
#define reg_mprj_coef7       (*(volatile uint32_t*)0x3800103c)
#define reg_mprj_coef8       (*(volatile uint32_t*)0x38001040)
#define reg_mprj_coef9       (*(volatile uint32_t*)0x38001044)
#define reg_mprj_coef10      (*(volatile uint32_t*)0x38001048)

#define reg_mprj_data        (*(volatile uint32_t*)0x38002000)
#define reg_mprj_last        (*(volatile uint32_t*)0x38002008)

#define reg_mprj_rcoef0      (*(volatile uint32_t*)0x38004020)
#define reg_mprj_rcoef1      (*(volatile uint32_t*)0x38004024)
#define reg_mprj_rcoef2      (*(volatile uint32_t*)0x38004028)
#define reg_mprj_rcoef3      (*(volatile uint32_t*)0x3800402c)
#define reg_mprj_rcoef4      (*(volatile uint32_t*)0x38004030)
#define reg_mprj_rcoef5      (*(volatile uint32_t*)0x38004034)
#define reg_mprj_rcoef6      (*(volatile uint32_t*)0x38004038)
#define reg_mprj_rcoef7      (*(volatile uint32_t*)0x3800403c)
#define reg_mprj_rcoef8      (*(volatile uint32_t*)0x38004040)
#define reg_mprj_rcoef9      (*(volatile uint32_t*)0x38004044)
#define reg_mprj_rcoef10     (*(volatile uint32_t*)0x38004048)
